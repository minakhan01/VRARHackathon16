...
namespace HoloToolkit.Unity
{
    ...
    public partial class GazeManager : Singleton<GazeManager>
    {
        ...
        private void Update()
        {
            ...
            Vector3 unit = new Vector3(0, -1, 1);
            unit = Quaternion.Euler(0, Camera.main.transform.localEulerAngles.y, 0) * unit;
            

            //gazeRotation = Camera.main.transform.rotation; //change here.
            gazeDirection = unit;
        ...
        private void UpdateRaycast()
        {
            ...
            //if (GazeStabilization != null) here
            //{
